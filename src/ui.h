...
#define ICON_RENDER_BUFFER_SIZE (ICON_BITMAP_BUFFER_SIZE * 2)
...
extern void pongNavigation();
extern void pongSpeed();
...
#define RIGHT_PART_WIDTH (SCREEN_WIDTH - LEFT_PART_WIDTH - 10)
		...
		lv_obj_set_style_text_font(lblSpeed, &lv_font_montserrat_48, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblSpeedUnit, &lv_font_montserrat_24, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblEta, &lv_font_montserrat_24, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblDistanceToNextRoad, &lv_font_montserrat_32, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblNextRoadDesc, &lv_font_montserrat_24, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblNextRoad, &lv_font_montserrat_28, LV_STATE_DEFAULT);
		...
		lv_obj_set_style_text_font(lblDistanceToNextRoad, &lv_font_montserrat_28, LV_STATE_DEFAULT);
		lv_obj_set_style_text_align(lblDistanceToNextRoad, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN);
